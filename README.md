...
## Reference
* Blog - [Building Java records from COBOL with the IBM Record Generator for Java](https://developer.ibm.com/components/ibmz/tutorials/build-java-records-from-cobol-with-ibm-record-generator/)
